...
SWITCH_TELEFONE_PRINCIPAL = (By.XPATH, "//input[@id='telefone_fixo_principal']/parent::label")
SWITCH_CELULAR_PRINCIPAL = (By.XPATH, "//input[@id='celular_principal']/parent::label")
CHECKBOX_TELEFONE_WHATSAPP = (By.XPATH, "//*[@data-phone-toggle='landline']//input[@id='telefone_is_wpp']")
CHECKBOX_CELULAR_WHATSAPP = (By.XPATH, "//*[@data-phone-toggle='cellphone']//input[@id='celular_is_wpp']")
SELECT_TIPOLOGIA = (By.ID, "tipologia")
CHECKBOX_TERMOS = (By.XPATH, "//input[@id='terms_accepted']")
...
#LGPD
CHECK_MARCAR_TODAS = (By.XPATH, "//div[@id='ecom:customer_consent:communication_table:row_select_all']//span[@class='promo-communication__checkmark']")
CHECK_WHATSAPP = (By.XPATH, "//div[@id='ecom:customer_consent:communication_table:row_channel_whatsapp']//span[@class='promo-communication__checkmark']")
CHECK_SMS = (By.XPATH, "//div[@id='ecom:customer_consent:communication_table:row_channel_sms']//span[@class='promo-communication__checkmark']")
CHECK_EMAIL = (By.XPATH, "//div[@id='ecom:customer_consent:communication_table:row_channel_email']//span[@class='promo-communication__checkmark']")
