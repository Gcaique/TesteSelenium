...
NEW_EMAIL = "smoketesting11@automatizacao.com.br"
...
def test_18_dashboard_sul(driver, setup_site, wait):
    ...
    # ------------------------------------------------------------
    # 13) OBRIGATÓRIO: Info da conta: whatsapp + editar email + cancelar
    # ------------------------------------------------------------
    # WhatsApp
