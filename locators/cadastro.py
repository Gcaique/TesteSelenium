...
BTN_INICIAR_CADASTRO = (
    By.XPATH,
    "//button[normalize-space()='Iniciar cadastro']"
)
...
SWITCH_CELULAR_PRINCIPAL = (
    By.XPATH,
    "//input[@id='celular_principal']/parent::label"
)

SWITCH_CELULAR_WHATSAPP = (
    By.XPATH,
    "//input[@id='celular_is_wpp']/parent::label"
)
...
MSG_TOKEN_INVALIDO = (
    By.XPATH,
    "//span[contains(normalize-space(),'Token')]"
)
...
BTN_CRIAR_CONTA = (
    By.XPATH,
    "//button[normalize-space()='Criar Conta']"
)
...
BTN_IR_HOME = (
    By.XPATH,
    "//div[@id='modal-register-success']//button"
)